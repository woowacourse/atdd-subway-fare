...
### 노선 관련 예외 처리 기능
- 동일한 이름의 노선은 등록할 수 없다. - CONFLICT(409)
- 동일한 색깔의 노선은 등록할 수 없다. - CONFLICT(409)
- 없는 ID, NAME, ... (Line의 필드)로 검색, 수정, 삭제할 수 없다. - 404
- 노선의 이름은 2자 이상의 한글 또는 숫자로 이루어져야만 한다. - 이를 어기면 400
- 공백 문자도 허용하지 않는다. - 400