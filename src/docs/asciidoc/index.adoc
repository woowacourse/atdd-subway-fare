...
=== 회원 가입
==== Request
include::{snippets}/loginMember-create/http-request.adoc[]
==== Response
include::{snippets}/loginMember-create/http-response.adoc[]

=== 회원 조회
==== Request
include::{snippets}/loginMember-find/http-request.adoc[]
==== Response
include::{snippets}/loginMember-find/http-response.adoc[]

=== 회원 수정
==== Request
include::{snippets}/loginMember-update/http-request.adoc[]
==== Response
include::{snippets}/loginMember-update/http-response.adoc[]

=== 회원 삭제
==== Request
include::{snippets}/loginMember-delete/http-request.adoc[]
==== Response
include::{snippets}/loginMember-delete/http-response.adoc[]
