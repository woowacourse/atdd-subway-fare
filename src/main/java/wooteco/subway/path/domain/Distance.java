...
public class Distance {
    private static final int FIRST_DISTANCE_THRESHOLD = 10;
    private static final int SECOND_DISTANCE_THRESHOLD = 50;
    ...
    private static final int FIRST_FULL_CHARGE = 800;
    ...
    public boolean isFirstOverCharge() {
        return distance > FIRST_DISTANCE_THRESHOLD && distance <= SECOND_DISTANCE_THRESHOLD;
    }

    public boolean isSecondOverCharge() {
        return SECOND_DISTANCE_THRESHOLD < distance;
    }

    public int calculateFirstOverCharge() {
        return (int) ((Math.ceil((distance - FIRST_DISTANCE_THRESHOLD) / FIRST_CHARGE_DISTANCE) + 1) * CHARGE_AMOUNT);
    }

    public int calculateSecondOverCharge() {
        return FIRST_FULL_CHARGE + (int) ((Math.ceil((distance - SECOND_DISTANCE_THRESHOLD) / SECOND_CHARGE_DISTANCE) + 1) * CHARGE_AMOUNT);
    }
