...
//                int distance = subwayPath.calculateDistance();
//
//                Fare fare = new Fare(distance, subwayPath.calculateLineMaxFare(), DistanceFareStrategy.find(distance));
//                int fareValue = fare.calculateFare();
//
...
//
//                Fare fare = new Fare(distance, subwayPath.calculateLineMaxFare(), strategy, AgeDiscountStrategy.find(5));
//                int fareValue = fare.calculateFare();
//
...
//                DistanceFareStrategy strategy = DistanceFareStrategy.find(distance);
//
//                Fare fare = new Fare(distance, subwayPath.calculateLineMaxFare(), strategy, AgeDiscountStrategy.find(age));
//                int fareValue = fare.calculateFare();
//
