...
public class PathAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        칠호선 = 지하철_노선_등록되어_있음("칠호선", "bg-red-600", a역, g역, 16);
        팔호선 = 지하철_노선_등록되어_있음("팔호선", "bg-red-600", a역, h역, 50);
        구호선 = 지하철_노선_등록되어_있음("구호선", "bg-red-600", a역, i역, 51);
        십호선 = 지하철_노선_등록되어_있음("십호선", "bg-red-600", a역, j역, 58);
        십일호선 = 지하철_노선_등록되어_있음("십일호선", "bg-red-600", a역, k역, 59);
