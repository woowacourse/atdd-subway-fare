...
import wooteco.subway.acceptance.line.dto.LineResponse;
...
import static wooteco.subway.acceptance.auth.AuthAcceptanceTest.로그인되어_있음;
import static wooteco.subway.acceptance.line.LineAcceptanceTest.지하철_노선_등록되어_있음;
import static wooteco.subway.acceptance.line.SectionAcceptanceTest.지하철_구간_등록되어_있음;
import static wooteco.subway.acceptance.member.MemberAcceptanceTest.회원_생성됨;
import static wooteco.subway.acceptance.member.MemberAcceptanceTest.회원_생성을_요청;
import static wooteco.subway.acceptance.station.StationAcceptanceTest.지하철역_등록되어_있음;
