...
public class PathAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        추가요금선 = 지하철_노선_등록되어_있음(new LineRequest("추가요금선", "bg-add-500", 남부터미널역.getId(), 새로운역.getId(), 4, 300));
    ...
    void findPathWithFare() {
        ...
        // 추가 요금선 + 성인 요금
        final ExtractableResponse<Response> response6 = 거리_경로_조회_요청(남부터미널역.getId(), 새로운역.getId(), token4);
