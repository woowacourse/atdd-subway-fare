...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    void createLineWithDuplicatedColor() {
        ...
        // when
        ExtractableResponse<Response> response = 지하철_노선_생성_요청(lineRequest3, tokenResponse);
    ...
    public static LineResponse 지하철_추가요금_노선_등록되어_있음(String name, String color, StationResponse upStation, StationResponse downStation, int distance, int fare, TokenResponse tokenResponse) {
