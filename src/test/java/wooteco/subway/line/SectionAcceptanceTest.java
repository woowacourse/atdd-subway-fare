...
public class SectionAcceptanceTest extends AcceptanceTest {
    ...
    public static void 지하철_구간_등록되어_있음(String accessToken, LineResponse lineResponse, StationResponse upStation,
        StationResponse downStation, int distance) {
        지하철_구간_생성_요청(accessToken, lineResponse, upStation, downStation, distance);
    }

    public static ExtractableResponse<Response> 지하철_구간_생성_요청(String accessToken, LineResponse line,
