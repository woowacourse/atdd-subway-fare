    ...
    class Describe_calculateFare {
        ...
        class Context_under10km {
            ...
            void setUp() {
                ...
                sections1 = new Sections(Arrays.asList(section1));
                sections2 = new Sections(Arrays.asList(section2));
                Line 이호선 = new Line(1L, "2호선", "black", 0, sections1);
                Line 삼호선 = new Line(2L, "3호선", "white", 0, sections2);
            ...
            void calculateBasicFare() {
                ...
                Fare fare = new Fare(subwayPath, DistanceFareStrategy.find(distance), AgeDiscountStrategy.find(DEFAULT_AGE));
        ...
        class Context_over10kmAndUnder50km {
            ...
            void calculateWeightedFare_15KM() {
                ...
                Fare fare = new Fare(path, DistanceFareStrategy.find(distance), AgeDiscountStrategy.find(DEFAULT_AGE));
                int fareValue = fare.calculateFare();
        ...
        class Context_AgeDiscount {
            ...
            void isFree() {
                ...
                Fare fare = new Fare(subwayPath, fareStrategy, AgeDiscountStrategy.find(3));
                int fareValue = fare.calculateFare();
