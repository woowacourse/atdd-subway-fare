...
public class AuthorizationLoginMemberAcceptanceTest extends AcceptanceTest {
    ...
    @DisplayName("회원 가입을 할 때 이메일이 중복된다.")
    @Test
    void insertMemberWithDuplicateEmail() {
        회원_생성을_요청(EMAIL, PASSWORD, AGE);
        ExtractableResponse<Response> createResponse = 회원_생성을_요청(EMAIL, PASSWORD, AGE);
        회원_생성을_실패(createResponse);
    }

    private void 회원_생성을_실패(ExtractableResponse<Response> response) {
